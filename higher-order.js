...
//Code Here
//acc = accumulator, current is current element
...
let orderTotals = orders.map(e => e.price * (1.0+e.tax))
...
let bobsTotal = purchases.reduce((acc, curr) =>{
  ...
  return acc//need return statement because don't have implied return(one line arrow function statement)
},0)//accumulator doesn't take in the first element
